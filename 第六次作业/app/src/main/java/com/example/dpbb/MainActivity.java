...
import com.example.dpbb.bean.UserInfo;
import com.example.dpbb.database.UserDBHelper;
import com.example.dpbb.util.DateUtil;
import com.example.dpbb.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener , CompoundButton.OnCheckedChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990001_鲍广帅"};
