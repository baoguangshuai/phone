...
import com.example.homeworkend.bean.UserInfo;
import com.example.homeworkend.database.UserDBHelper;
import com.example.homeworkend.util.DateUtil;
import com.example.homeworkend.util.ViewUtil;
...
public class MainMenu extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener , CompoundButton.OnCheckedChangeListener {
    ...
    private String[] typeArray = {"战士", "VIP战士","V8战士"};
